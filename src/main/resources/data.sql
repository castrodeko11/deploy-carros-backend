...
--Table User
insert into user(id,nome,email,login,senha) values (1,'Andre Oliveira','deko11@gmail.com','deko11','$2a$10$Dki279KL4ZUsdbCXcwgB6uSkFCEqPbEeIF7xMXlEDVE06UHFMkImO');
insert into user(id,nome,email,login,senha) values (2,'Admin','admin@gmail.com','admin','$2a$10$Dki279KL4ZUsdbCXcwgB6uSkFCEqPbEeIF7xMXlEDVE06UHFMkImO');
