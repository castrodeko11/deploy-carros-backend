...
public class CarrosAPITest {
    ...
    private ResponseEntity<CarroDTO> getCarro(String url) {
        return
                rest.withBasicAuth("admin","user").getForEntity(url, CarroDTO.class);
    }

    private ResponseEntity<List<CarroDTO>> getCarros(String url) {
        return rest.withBasicAuth("admin","user").exchange(
                url,
                HttpMethod.GET,
                null,
    ...
    public void testSave() {
        ...
        // Insert
        ResponseEntity response = rest.withBasicAuth("admin","user").postForEntity("/api/v1/carros", carro, null);
        ...
        // Deletar o objeto
        rest.withBasicAuth("admin","user").delete(location);
